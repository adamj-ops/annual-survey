...
export function Step0Welcome() {
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="w-full py-3 sm:py-3">
        <div className="max-w-2xl mx-auto px-4 text-center text-[14px] sm:text-[16px] text-muted-foreground space-y-3">
          <p className="font-semibold">We want to hear from you!</p>
